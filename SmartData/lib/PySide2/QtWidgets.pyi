...
class QListWidgetItem(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, icon:PySide2.QtGui.QIcon, text:str, listview:PySide2.QtWidgets.QListWidget=..., type:int=...): ...
    @typing.overload
    def __init__(self, listview:PySide2.QtWidgets.QListWidget=..., type:int=...): ...
    @typing.overload
    def __init__(self, other:PySide2.QtWidgets.QListWidgetItem): ...
    @typing.overload
    def __init__(self, text:str, listview:PySide2.QtWidgets.QListWidget=..., type:int=...): ...
