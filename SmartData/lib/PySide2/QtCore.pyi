...
class QLocale(Shiboken.Object):
    ...
    @typing.overload
    def toLong(self, s:str, ok:bool=...) -> int: ...
    @typing.overload
    def toLong(self, s:str, ok:bool=...) -> int: ...
    ...
    @typing.overload
    def toULong(self, s:str, ok:bool=...) -> int: ...
    @typing.overload
    def toULong(self, s:str, ok:bool=...) -> int: ...
...
class QSettings(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, scope:PySide2.QtCore.QSettings.Scope, parent:PySide2.QtCore.QObject=...): ...
